...
//sql2 获取总记录数 计算总页数
$sql="select count(*)from  olddeal_user RIGHT JoIN wantBuy ON olddeal_user.uname = wantBuy.uname where buyStatus=1";
...
$sql="select *from olddeal_user RIGHT JoIN wantBuy ON olddeal_user.uname = wantBuy.uname where buyStatus=1 limit $start,$count";
$result=mysqli_query($conn,$sql);
