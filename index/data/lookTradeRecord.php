...
//sql2 获取总记录数 计算总页数
$sql="select count(*)from  soldOrder where sname= '$uname'AND status=3 OR status=-1";
...
$sql="select * from  soldOrder where sname='$uname' AND status=3 OR status=-1 limit $start,$count";
$result=mysqli_query($conn,$sql);
